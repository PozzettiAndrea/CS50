...
int main(int argc, char *argv[])
{
    ...
    // ensure n is smaller than 100
    if (n < 1 || n > 100)
    {
        fprintf(stderr, "Nope. n has to be a positive integer, smaller than 100\n");
        return 1;
    }
    ...
    // Create outfile's BITMAPINFOHEADER and change biWidth, biHeight, biSize
